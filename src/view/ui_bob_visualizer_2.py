...
class ViewUIBob:
    ...
    def start(self):
        ...
        self.curve_tab1.attach(self.uiplot.qwtPlot_tab1)
        self.curve_2_tab1.attach(self.uiplot.qwtPlot_tab1)
        self.uiplot.qwtPlot_tab1.setAxisScale(self.uiplot.qwtPlot_tab1.yLeft, 0, 1 * 1000)
        self.uiplot.qwtPlot_tab1.setAxisScale(self.uiplot.qwtPlot_tab1.xBottom, 18117.1875, 18843.75)
