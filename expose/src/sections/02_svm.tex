...
\begin{figure}[htbp] \centering
    \includegraphics[height=40mm]{svm/svm_1.png}
...
Die SVM ist ein binärere Klassifikator, d. h. er kann eine Objektzuordnung nur zwischen zwei Klassen durchführen. 
...
- ''ref/images/svm/svm_confmat.png'' zeigt die visuelle Repräsentation einer Confusion-Matrix
