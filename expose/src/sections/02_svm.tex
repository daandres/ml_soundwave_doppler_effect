...
\begin{figure}[h!]
  \centering
    \includegraphics[width=0.95\textwidth]{svm_1.png}
  \caption{Trennlinie zwischen zwei Klassen}
\end{figure}
...
\begin{figure}[h!]
  \centering
    \includegraphics[width=0.95\textwidth]{svm_2.png}
  \caption{Trennung zweier nicht-linear separierbaren Klassen mittels Kernel Trick}
\end{figure}
...
\begin{figure}[h!]
  \centering
    \includegraphics[width=0.95\textwidth]{svm_data_1.png}
