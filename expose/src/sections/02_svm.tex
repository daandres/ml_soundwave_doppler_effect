...
\begin{figure}[htbp] \centering
    \subfigure[AND-Pezeptron mit einem Neuron]{\includegraphics[width=0.22\textwidth]{svm/svm_perceptron.png}}
    \subfigure[AND linear separierbar in $\mathbb{R}^2$]{\includegraphics[width=0.22\textwidth]{svm/svm_and.png}}
...
Knapp 40 Jahre Jahre später veröffentliche der sowjetisch-amerikanische Mathematiker Wladimir Wapnik \cite{Vapnik} das Prinzip der Support-Vector-Machines (\ac{SVM}).
...
Gängige Kernfunktionen sind \cite[]{Marsland}:
\begin{itemize}
...
Es ist nun möglich, dass mehrere Instanzen eine positive Klassenzuordnung feststellen nicht die Restklasse klassifizieren. 
