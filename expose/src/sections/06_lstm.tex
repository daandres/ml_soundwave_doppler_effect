...
In einem Netz mit \ac{LSTM}-Einheiten sind diese keine einzelnen
...
\begin{figure}[htfp]
	\begin{center}
	\includegraphics[width=0.7\columnwidth]{lstm/lstm_block}
...
\autoref{fig:lstm_block} zeigt den Aufbau eines \ac{LSTM}-Blocks. Dort werden
