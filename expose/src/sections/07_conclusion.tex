...
%Ein zusätzlicher Punkt der im Projekt bisher nur am Rande behandelt wurde, ist die Integration mit dem Hostsystem. Die Gesten sollen einer bestimmten Aktion zugeordnet werden. Dazu werden bei
...
%erkannt werden, keine Klassifikation ist vor einer falschen Klassifikation
