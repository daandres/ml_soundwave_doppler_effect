...
%TODO Bilder Frames Gesten + Gesten bzw Besonderheiten beschreiben (vor eigentlicher Vorverarbeitung, ggf. nach normalisierung??)
...
\autoref{fig:kMeansWertK} zeigt ein Beispiel, bei dem der k-Means Algorithmus bei zwei Gruppen von Daten mit einem Wert von k = 2 ein sehr ungenaues Ergebnis liefert. Für k=4 funktioniert das Clustering sehr gut, da pro Gruppe zwei Cluster-Zentren existieren. %TODO Satz
