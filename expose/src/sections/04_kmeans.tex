...
Zur Klassifikation werden die Gesten in zwei Gruppen eingeteilt. 
...
%Da die Gesten ... nicht unterstützt werden, sind bei der Evaluation nur die Gesten
Nicht vom Klassifikator unterstützt und daher nicht bei der Evaluation berücksichtigt werden die Gesten ... Zum Testen der Erkennungsrate wurden die übrigen Gesten sowie die eigene Geste ... jeweils XX mal ausgeführt. Die Ergebnisse der Klassifikation sind in  \autoref{matrix_kMeansEvaluation} als Wahrheitsmatrix dargestellt. Die Reihenfolge der Gesten ist dabei (von links nach rechts beziehungsweise von oben nach unten) ... (...)
...
\hline
 ...
 \hline
  \ac{DPO} &xx,xx \% \\
 \hline
 XXX (eigene Geste) &xx,xx \% \\
 \hline
  \ac{BNS} \& \ac{BNN} (Hintergrund\-rauschen) &xx,xx \%\\
 \hline
\end{tabular}
...
Mit dem implementierten k-Means Klassifikationssystem können die Gesten ... in Echtzeit erkannt und voneinander unterschieden werden.
Die Geste ... wird nicht vom Klassifikator unterstützt, da sie sich nicht deutlich genug von der Geste .. unterscheidet. Weiterhin kann die Geste .. nicht erkannt werden, da sie keine erkennbaren Unterschiede zum Grundrauschen aufweist. Als zusätzliche Geste wird die Bewegung einer Hand von unten nach oben unterstützt.
Am besten erkannt werden die Gesten ... mit einer Erkennungsrate von ... beziehungsweise .. Prozent. Weniger gut erkannt werden die Gesten ... (.. Prozent) und .. (.. Prozent). 
...
% Möglichkeit, die sehr ähnlichen Gesten XXX und XXX zu unterscheiden?
