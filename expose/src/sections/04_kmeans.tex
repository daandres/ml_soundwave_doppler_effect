...
%TODO kMeans(++) mit kleinem Bild erläutern
...
%TODO Es fehlen hier noch ein paar Worte zu den Daten die Sie clustern. Nehmen Sie einfach die Rohdaten oder Filtern Sie die Daten noch auf irgendeinen Art und Weisen (Reduzieren, Quantisieren, …)? Ah, ich sehe, das kommt später. Man sollte hier evtl. darauf hinweisen, dass das noch erklärt wird. 
...
Der Klassifikator wurde nur geringfügig angepasst. Die Startpunkte der Cluster-Zentren wurden nicht wie im ursprünglichen Algorithmus zufällig gewählt, sondern mithilfe des in Abschnitt~\ref{subsec:kMeansFunktionsweise} vorgestellten k-Means++ Algorithmus bestimmt.
%TODO ??? Das verstehe ich nicht. Die Trainingsphase besteht doch in der Bestimmung der Cluster-Zentren (mit k-Means) ??!
...
%TODO Abschnitt 4.2.4 Training gehört weiter nach oben. Er hat ja nichts mit Ihren speziellen Daten zu tun. Sie erklären hier allgemein wie k-Means funktioniert. 
