...
\end{tabular} 
\caption[Tests für Trainigverfahren]{Tests um instabiles Ergebnisverhalten des Trainingverfahrens Backpropagation zu zeigen. Werte geben Fehlerrate des Netzwerks an. Outputlayerart ist \texttt{Softmax}. }
\label{tab:outlayertests}
\end{table}
...
{\textbf{LSTM-Blöcke}}{\textbf{Iterationen}} & \textbf{250} & \textbf{500} & \textbf{750} & \textbf{1000} & \textbf{1250} & \textbf{1500}\\
 \hline
